...
<div class="hidden lg:flex justify-between items-center bg-neutral-900 text-orange-50 p-2 rounded-xl shadow-md m-auto text-sm">
    ...
    <select name="bahan_bkr" class="bg-neutral-800 p-1 rounded-lg focus:ring-2 focus:ring-orange-500">
...
<div id="typebar" class="fixed z-200 left-0 top-0 w-full p-8 space-y-6 bg-neutral-900 h-full overflow-y-auto scrollbar-hide transform -translate-x-full transition-all duration-300">
    ...
    <div class="flex flex-col gap-3">
        ...
        <label for="">
        <input type="radio" name="harga" value="harga">
        Semua
        </label>
        <label for="">
        <input type="radio" name="harga" value="lt1000000">
        Kurang dari 1000000
        </label>
        <label for="">
        <input type="radio" name="harga" value="lt1000000">
    ...
    <div class="flex flex-col gap-3">
        ...
        <label for="">
        <input type="radio" name="transmisi" value="transmisi">
        Semua
        </label>
        <label for="">
    ...
    <div class="flex flex-col gap-3">
        ...
        <label for="">
        <input type="radio" name="bahan_bkr" value="bahan_bkr">
        Semua
        </label>
        <label for="">
        <input type="radio" name="bahan_bkr" value="listrik">
        Listrik
        </label>
        <label for="">
        <input type="radio" name="bahan_bkr" value="bensin">
        Bensin
        </label>
    </div>
    <div class="flex flex-col gap-3">
        ...
        <label for="">
        <input type="radio" name="kapasitas" value="kapasitas">
        Semua
        </label>
        <label for="">
