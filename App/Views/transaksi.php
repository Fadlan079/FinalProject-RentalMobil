...
<head>
    ...
    <title>Transaksi - Rent Car Cylc</title>
...
<body class="bg-neutral-100 text-neutral-800 font-sans">
    <aside class="fixed left-0 top-0 w-64 h-full bg-neutral-900 text-neutral-200 flex flex-col justify-between rounded-r-3xl shadow-lg">
        <div>
            ...
            <a href="transaksi.php" class="px-6 py-3 bg-orange-500/20 text-orange-400 font-semibold rounded-r-full"><i class="fa-solid fa-file-contract"></i> Transaksi</a>
    ...
    <main class="ml-64 p-8">
        <header class="flex justify-between items-center mb-8">
            ...
            <button class="bg-orange-500 text-neutral-200 p-2 rounded-xl shadow-xl hover:bg-orange-400 active:scale-90 transition-all duration-300"><i class="fa-solid fa-plus"></i> Tambah Transaksi</button>
        </header>
                ...
                <?php if(!empty($datatransaksi)):?>
                    <?php foreach($datatransaksi as $row):?>
                        <tr class="border-b hover:bg-orange-400/20 transition-all duration-300 text-sm text-left">
                            ...
                            <th class="px-3 py-3"><?= htmlspecialchars($row['total_bayar'])?></th>
