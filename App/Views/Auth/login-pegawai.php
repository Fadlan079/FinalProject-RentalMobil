...
<body class="bg-[url('../src/assets/Jesko%20absolut.jpeg')] bg-cover bg-center bg-no-repeat h-screen flex justify-center items-center">
    <form action="login.php" method="POST"class="bg-indigo-50 p-8 rounded-lg shadow-lg w-full max-w-sm">
    
    <h2 class="text-2xl font-bold mb-6 text-center text-gray-800">Login</h2>
    
    <div class="mb-4">
      <input type="text" name="identifier" placeholder="Nama / Email / Telepon" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-500" />
    </div>
