    ...
    <div class="relative z-10 max-w-6xl mx-auto mt-6 px-4">
        ...
        <?php else: ?>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                ?>
                <div class="bg-neutral-900  shadow-md rounded-xl p-4 flex flex-col md:flex-row items-center justify-between border-t-4 border-gray-100 hover:shadow-lg transition-shadow duration-300">
