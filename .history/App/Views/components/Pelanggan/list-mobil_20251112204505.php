...
<script>
  // Fungsi reusable untuk buka/tutup modal
  function setupModal(modalId, closeBtnId, triggerSelector = null) {
    ...
    // Jika ada trigger (misal tombol detail mobil)
    if (triggerSelector) {
  ...
  // Setup modal #modalDetail dengan tombol #closeModal dan semua tombol .btn-detail
  const modalDetailCtrl = setupModal('modalDetail', 'closeModal', '.btn-detail');

  // Jika mau, bisa panggil modal secara manual
  // modalDetailCtrl.open();
  // modalDetailCtrl.close();
</script>
