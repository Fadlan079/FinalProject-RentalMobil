...
<div class="flex items-center gap-5 border-b border-neutral-700 pb-4 mb-5">
  ...
  <div class="flex-1">
    ...
    <p class="text-neutral-400 mb-1">${data.tahun} • ${data.status} • ${data.bhn_bkr}</p>
    
    <div class="grid grid-cols-2 md:grid-cols-3 gap-1 text-sm text-neutral-400">
      ...
      <div class="col-span-2 md:col-span-3"><span class="font-medium text-neutral-200">Harga:</span> Rp ${parseFloat(data.harga).toLocaleString()}/hari</div>
    </div>
  </div>
</div>
