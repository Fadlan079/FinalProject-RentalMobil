...
<aside id="sidebar" class="fixed z-200 left-0 top-0 w-full p-8 space-y-6 bg-neutral-900 h-full transform -translate-x-full transition-all duration-300">
    ...
    <nav class="text-orange-50 flex flex-col gap-5 mt-5">
        ...
        <?php if(isset($_SESSION['user'])):?>
            <a href="index.phpo?action=riwayat-transaksi" class="p-4"><i class="fa-solid fa-clock-rotate-left text-orange-500"></i> <span>Riwayat Transaksi</span></a>
<button type="button" id="ProfileBtn" 
    class="p-4 flex items-center gap-2 border-2 border-orange-500 text-orange-500 rounded-xl font-semibold hover:bg-orange-500 hover:text-white transition-colors duration-200">
    <i class="fa-solid fa-id-badge text-orange-400"></i>
    Profil Saya
</button>
