...
<script>
  ...
  function lihatDetail(id) {
    ...
    <i class="fa-solid fa-spinner text-orange-500 text-4xl items-center mb-4 animate-spin"></i>`;
...
<div class="mt-6 flex justify-end">
  <button id="btnSewa" 
          data-id="${data.id}" 
          class="bg-orange-500 hover:bg-orange-600 text-neutral-100 px-5 py-2 rounded-lg font-medium shadow-md transition-all">
    Sewa Sekarang
  </button>
</div>
        `;
