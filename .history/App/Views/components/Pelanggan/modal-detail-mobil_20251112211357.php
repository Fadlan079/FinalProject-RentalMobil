<head>
  <!-- Font Awesome 6 CDN -->
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css" integrity="sha512-p0XWawLjK9Bv+3ozlv4mF9LXH0tXzGJtflpKrjDpU9r8w1QZ2t0YNXK2G0kC3fP0iOq2zU2OjYcJvQf0XWZ6Yw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
...
<div id="modalDetail" class="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm hidden">
  <div class="relative bg-neutral-900 text-neutral-100 rounded-2xl shadow-2xl w-full max-w-3xl p-6 border border-neutral-800">
    ...
    <div id="modalContent">
      <i class="fa-solid fa-spinner text-orange-500 text-4xl mb-4 animate-spin"></i>
