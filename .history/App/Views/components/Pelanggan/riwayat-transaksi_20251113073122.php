        ...
        <form id="editForm">
            ...
            <div class="mb-3">
                ...
                <input type="date" name="tgl_kembali" id="edit_tgl_kembali" 
                       class="w-full border-2 border-neutral-700 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500"
                       min="<?= date('Y-m-d') ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="total_bayar" id="edit_total_bayar" min="0" step="0.01"
                       class="w-full border-2 border-neutral-800  rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-500">
            </div>
