...
<div class="relative rounded-2xl overflow-hidden shadow-xl w-full max-w-4xl mx-auto">
  <!-- Slider container -->
  <div id="slider" class="flex transition-transform duration-700 ease-in-out">
    <img src="assets/jesko.svg" alt="Koenigsegg Jesko" class="w-full flex-shrink-0 object-cover h-[250px] sm:h-[350px] md:h-[450px]">
    <img src="assets/lotus-evija.svg" alt="lotus-evija" class="w-full flex-shrink-0 object-cover h-[250px] sm:h-[350px] md:h-[450px]">
    <img src="assets/ilustration-2.svg" alt="ilustration" class="w-full flex-shrink-0 object-cover h-[250px] sm:h-[350px] md:h-[450px]">
    <img src="assets/4.svg" alt="ilustration" class="w-full flex-shrink-0 object-cover h-[250px] sm:h-[350px] md:h-[450px]">
    <img src="assets/5.svg" alt="ilustration" class="w-full flex-shrink-0 object-cover h-[250px] sm:h-[350px] md:h-[450px]">
    <img src="assets/6.svg" alt="ilustration" class="w-full flex-shrink-0 object-cover h-[250px] sm:h-[350px] md:h-[450px]">
    <img src="assets/7.svg" alt="ilustration" class="w-full flex-shrink-0 object-cover h-[250px] sm:h-[350px] md:h-[450px]">
  </div>
</div>
...
<body class="h-screen bg-neutral-200 font-serif">
  <header class="h-screen">
    ...
    <div class="whitespace-nowrap p-3 shadow-xl overflow-hidden">
      <p class="inline-block [animation:marquee_10s_linear_infinite] [@keyframes_marquee]:[0%{transform:translateX(100%)}_100%{transform:translateX(-100%)}]">rental mobil</p>
    </div>
  </header> -->