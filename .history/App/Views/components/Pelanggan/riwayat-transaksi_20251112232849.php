...
<body class="bg-neutral-100 text-neutral-900">
    ...
    <div class="relative z-10 max-w-6xl mx-auto mt-6 px-4">
        ...
        <!-- Statistik Ringkas -->
<span class="px-2 py-1 rounded-full text-xs font-semibold bg-green-100 text-green-700">Selesai</span>
<span class="px-2 py-1 rounded-full text-xs font-semibold bg-yellow-100 text-yellow-700">Berjalan</span>
<span class="px-2 py-1 rounded-full text-xs font-semibold bg-red-100 text-red-700">Batal</span>
