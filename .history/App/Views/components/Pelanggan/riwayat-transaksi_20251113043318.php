...
<div class="relative max-w-6xl mx-auto mt-6 px-4">

    <!-- Judul -->
    <h1 class="text-3xl font-bold text-center mb-6 text-orange-500">Riwayat Transaksi Kamu</h1>

    <!-- Tombol Kembali -->
    <div class="mb-4">
        <a href="index.php?action=index" class="inline-flex items-center gap-2 px-4 py-2 bg-orange-500 hover:bg-orange-400 text-white font-medium rounded-lg transition-colors">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white shadow-md rounded-xl p-4 flex flex-col md:flex-row items-center justify-between border border-gray-100">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h2 class="text-lg font-semibold"><?= htmlspecialchars($tr['merk'].' '.$tr['model'].' ('.$tr['tahun'].')') ?></h2>
                            <p class="text-sm text-gray-600">Tipe: <?= htmlspecialchars($tr['tipe']) ?></p>
                ...
                <div class="bg-gray-50 shadow-sm rounded-xl p-4 flex flex-col md:flex-row items-center justify-between border border-gray-100">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">No Plat: <?= htmlspecialchars($tr['noplat']) ?></p>
                            <p class="text-sm text-gray-600">Durasi: <?= $tr['durasi_sewa'] ?> hari</p>
                            <p class="text-sm text-gray-600">Total: Rp <?= number_format($tr['total_bayar'],2) ?></p>
