...
<!-- Modal Edit -->
<div id="editModal" class="hidden fixed inset-0 bg-neutral-900/50  flex items-center justify-center z-50">
    <div class="bg-neutral-900 border-t-5 border-orange-500 p-6 rounded-lg w-96 max-w-full mx-4">
