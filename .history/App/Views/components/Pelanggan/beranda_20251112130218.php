<div class="relative my-15 flex items-center justify-center px-4 group">
  ...
  <div class="relative rounded-2xl overflow-hidden shadow-xl max-w-3xl w-full">
    ...
    <div class="absolute inset-0 py-20 bg-gradient-to-t from-neutral-900/80 via-neutral-900/40 to-transparent backdrop-blur-[1px] flex flex-col justify-center items-center text-center gap-6 text-neutral-100 px-4">
