...
<div class="text-orange-50 flex flex-col gap-5 mt-5">
    ...
    <label for="">Bio</label>
    <textarea name="bio" value="" placeholder="Ceritakan sedikit tentang diri Anda..." class="p-2 border-2 border-neutral-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 transition-all duration-300"></textarea>
