                ...
                <div class="bg-neutral-900  shadow-md rounded-xl p-4 flex flex-col md:flex-row items-center justify-between border-t-5 border-orange-500 hover:shadow-lg transition-shadow duration-300">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-400">Model / Tipe: <?= htmlspecialchars($tr['model'] ?? '-') ?> / <?= htmlspecialchars($tr['tipe'] ?? '-') ?></p>
                            <p class="text-sm text-gray-400">No Plat: <?= htmlspecialchars($tr['noplat'] ?? '-') ?></p>
                            <p class="text-sm text-gray-400">Durasi: <?= $tr['durasi_sewa'] ?> hari</p>
                            <p class="text-sm text-gray-400">Harga / Hari: Rp <?= number_format($harga_per_hari,2) ?></p>
                            <p class="text-sm text-gray-400">Tanggal Sewa: <?= date('d M Y', strtotime($tr['tgl_sewa'])) ?></p>
                            <p class="text-sm text-gray-400">Tanggal Kembali: <?= date('d M Y', strtotime($tr['tgl_kembali'])) ?></p>
