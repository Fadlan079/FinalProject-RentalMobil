...
<form action="index.php" method="GET" class="max-w-6xl mx-auto flex flex-col lg:flex-row justify-between items-stretch lg:gap-3">
    ...
    <div class="hidden text-orange-50 flex flex-col gap-5 mt-5 mb-10">
        <div class="flex flex-col gap-3">
            ...
            <label class="flex items-center gap-2 <?= $harga == 'lt5jt' ? 'text-orange-500 font-semibold' : '' ?>">
                <input type="radio" name="harga" value="lt5jt" <?= $harga == 'lt5jt' ? 'checked' : '' ?>>
        ...
        <div class="flex flex-col gap-3">
            ...
            <label class="flex items-center gap-2 <?= $transmisi == 'semua' ? 'text-orange-500 font-semibold' : '' ?>">
                <input type="radio" name="transmisi" value="semua" <?= $transmisi == 'semua' ? 'checked' : '' ?>>
                <span>Semua</span>
            </label>
            
            <label class="flex items-center gap-2 <?= $transmisi == 'automatic' ? 'text-orange-500 font-semibold' : '' ?>">
                <input type="radio" name="transmisi" value="automatic" <?= $transmisi == 'automatic' ? 'checked' : '' ?>>
                <span>Automatic</span>
            </label>
            
            <label class="flex items-center gap-2 <?= $transmisi == 'manual' ? 'text-orange-500 font-semibold' : '' ?>">
                <input type="radio" name="transmisi" value="manual" <?= $transmisi == 'manual' ? 'checked' : '' ?>>
                <span>Manual</span>
            </label>
        </div>
