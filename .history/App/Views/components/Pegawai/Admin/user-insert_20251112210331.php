...
<form action="index.php?action=Pegawai" method="POST" 
    ...
    <input type="text" id="email" name="email" placeholder="Masukkan email unik" u
    ...
    <a href="index.php?action=createPegawai" 
