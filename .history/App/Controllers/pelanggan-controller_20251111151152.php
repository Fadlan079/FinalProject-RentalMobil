...
class PELANGGANController{
    ...
    $hasFilter = !empty($harga) || !empty($transmisi) || !empty($bhn_bkr);
    ...
    if (!empty($query)) {
        ...
        $data = $this->mobilmodel->filterMobil($harga, $transmisi, $bhn_bkr, null, $limit, $offset);
        $totalData = $this->mobilmodel->countFilterMobil($harga, $transmisi, $bhn_bkr, null);
    } else {
        // 🚗 Default: semua mobil
