...
class PELANGGANController{
    ...
    public function Storetransaksi() {
        ...
        $status = 'berjalan'; // ✅ harus sesuai enum
...
public function riwayatTransaksi() {
    ...
    // Pisahkan data pesanan dan riwayat
...
public function updatePesanan() {
    ...
    $update = $this->transaksimodel->updateTransaksi($id_transaksi, $tgl_kembali, $durasi_sewa, $total_bayar, $status);
    
    if ($update) {
        echo json_encode(['success' => 'Pesanan berhasil diperbarui']);
    } else {
...
public function deletePesanan() {
    ...
    $delete = $this->transaksimodel->deleteTransaksi($id_transaksi);
    if ($delete) {
