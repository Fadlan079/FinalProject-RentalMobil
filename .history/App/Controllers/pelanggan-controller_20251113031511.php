...
public function riwayatTransaksi() {
    ...
    $riwayat = $this->transaksimodel-ll($id_pelanggan);
    ...
    // Pisahkan pesanan & riwayat untuk kemudahan di view
    $pesanan = array_filter($riwayat, fn($tr) => $tr['status'] === 'berjalan');
    $riwayat_selesai = array_filter($riwayat, fn($tr) => in_array($tr['status'], ['selesai', 'batal']));
