    ...
    public function listPegawai()
{
        ...
        $pegawaiList = $this->model->getAllPegawai();  // ambil semua data pegawai
         require_once __DIR__ . '/../../App/Views/components/Pegawai/Admin/user-select.php';
}
    ...
    public function createPegawai() {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            $this->model->insertpegawai($_POST['nama'], $_POST['kelas']);
            header("Location: index.php");
        }

        require_once __DIR__ . '/../../App/Views/components/Pegawai/Admin/createuser.php';
    }
    ...
    public function storePegawai() {
        ...
        $this->model->Insertpegawai($email, $hashed, $role);
    ...
    public function updatePegawai() {
        ...
        $this->model->updatePegawai($id, $nama, $email, $role, $password);
