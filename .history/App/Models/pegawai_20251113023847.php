...
class Pegawai{
    ...
    public function Insertpegawai($id_user,$nama,$tmpt_lhr,$tgl_lhr,$alamat,$kel,$kec,$kota,$KP,$telp,$bio,$pp,$jabtan){
        try{
            $sql = "INSERT INTO pegawai(id_user,nama,tmpt_lhr,tgl_lhr,alamat,kel,kec,kota,KP,telp,bio,pp,jabatan) VALUES(:id_user,:nama,:tmpt_lhr,:tgl_lhr,:alamat,:kel,:kec,:kota,:KP,:telp,:bio,:pp,:jabatan)";
    ...
    public function getPegawaiByUserId($id_user){
        try{
            $sql = "SELECT * FROM pe WHERE id_user = :id_user";
            $stmt = $this->pdo->prepare($sql);
