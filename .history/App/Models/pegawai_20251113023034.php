...
class Pegawai{
    ...
    public function Insertpegawai($id_user,$nama,$tmpt_lhr,$tgl_lhr,$alamat,$kel,$kec,$kota,$KP,$telp,$bio,$pp){
        try{
            $sql = "INSERT INTO pegawai(id_user,nama,tmpt_lhr,tgl_lhr,alamat,kel,kec,kota,KP,telp,bio,pp) VALUES(:id_user,:nama,:tmpt_lhr,:tgl_lhr,:alamat,:kel,:kec,:kota,:KP,:telp,:bio,:pp)";
