...
class Transaksi {
    ...
    public function checkMobilAvailability($id_mobil, $tgl_sewa, $tgl_kembali, $exclude_id = null) {
    $sql = "SELECT COUNT(*) as count FROM transaksi 
            WHERE id_mobil = :id_mobil 
            AND status IN ('berjalan', 'dipesan')
            AND (
                (:tgl_sewa BETWEEN tgl_sewa AND tgl_kembali)
