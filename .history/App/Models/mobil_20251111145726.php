...
class Mobil{
    ...
    public function filterMobil($harga = null,$transmisi = null, $bhn_bkr = null, $kursi = null,$limit = null,$offset = null){
        try{
            ...
            if ($harga === 'lt1jt') $sql .= " AND harga < 1000000";
            elseif ($harga === 'lt5jt') $sql .= " AND harga < 5000000";
            ...
            if (!empty($kursi) && $kursi != 'semua') {
                if ($kursi === '4-5') {
                    $sql .= " AND kursi BETWEEN 4 AND 5";
                } elseif ($kursi === '6-8') {
                    $sql .= " AND kursi BETWEEN 6 AND 8";
                } else {
                    $sql .= " AND kursi = ?";
                    $params[] = $kursi;
                }
    ...
    public function countFilterMobil($harga = null, $transmisi = null, $bahan_bkr = null, $kursi = null) {
        try {
