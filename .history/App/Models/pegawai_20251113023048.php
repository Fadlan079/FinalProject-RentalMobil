...
class Pegawai{
    ...
    public function Insertpegawai($id_user,$nama,$tmpt_lhr,$tgl_lhr,$alamat,$kel,$kec,$kota,$KP,$telp,$bio,$pp){
        try{
            $sql = "INSERT INTO pegawai(id_user,nama,tmpt_lhr,tgl_lhr,alamat,kel,kec,kota,KP,telp,bio,pp) VALUES(:id_user,:nama,:tmpt_lhr,:tgl_lhr,:alamat,:kel,:kec,:k,:KP,:telp,:bio,:pp)";
    ...
    public function getPegawaiByUserId($id_user){
        try{
            ...
            $pegawa $stmt->fetch(PDO::FETCH_ASSOC);
        }catch(PDOException $e){
