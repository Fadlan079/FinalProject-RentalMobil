...
class Pegawai{
    ...
    public function Insertpegawai($id_user,$nama,$tmpt_lhr,$tgl_lhr,$alamat,$kel,$kec,$kota,$KP,$telp,$bio,$pp,$jabtan){
        try{
            $sql = "INSERT INTO pegawai(id_user,nama,tmpt_lhr,tgl_lhr,alamat,kel,kec,kota,KP,telp,bio,pp,jabatan) VALUES(:id_user,:nama,:tmpt_lhr,:tgl_lhr,:alamat,:kel,:kec,:k,:KP,:telp,:bio,:pp,:jabatan)";
