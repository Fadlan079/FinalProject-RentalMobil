...
class Pegawai{
    ...
    public function insertPegawai(
        ...
        $bio = '',
        $pp = '',
        $jabatan = 'customer service' // default
    ) {
        try {
            $sql = "INSERT INTO pegawai 
                (id_user, nama, tmpt_lhr, tgl_lhr, alamat, kel, kec, kota, KP, telp, bio, pp, jabatan) 
                VALUES 
                (:id_user, :nama, :tmpt_lhr, :tgl_lhr, :alamat, :kel, :kec, :kota, :KP, :telp, :bio, :pp, :jabatan)";
            ...
            throw new Exception("Gagal insert pegawai: " . $e->getMessage());
        }
    }
