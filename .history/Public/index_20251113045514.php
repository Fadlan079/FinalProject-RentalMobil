...
switch ($action) {
    ...
    case 'updatePesanan':
        ...
        break;
    case 'updatePesananFull': // TAMBAHKAN
        $Pelanggancontroller->updatePesananFullAjax();
        break;
    case 'getDetailPesanan': // TAMBAHKAN
        $Pelanggancontroller->getDetailPesananAjax();
        break;
    case 'deletePesanan':
        $Pelanggancontroller->deletePesananAjax();
        break;
    case 'batalkanPesanan': // TAMBAHKAN
        $Pelanggancontroller->batalkanPesananAjax();
        break;
    case 'getPesananAjax':
        $Pelanggancontroller->getPesananAjax();
        break;
    case 'getRiwayatAjax':
        $Pelanggancontroller->getRiwayatAjax();
        break;
